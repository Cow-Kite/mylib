...
from distributed import DistContext, LocalGraphStore, LocalFeatureStore, DistNeighborLoader
...
def run_proc(
    ...
    model = GraphSAGE(
        ...
        out_channels=349 if is_hetero else 47,
    ).to(current_device)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=int,
        default=11112,
        help='The port used for Local communication across training samplers',
    )
    parser.add_argument(
            '--test_loader_port',
            type=int,
