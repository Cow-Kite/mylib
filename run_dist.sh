...
python3 test_launch.py --workspace ${PYG_WORKSPACE} --ip_config ${IP_CONFIG} --ssh_username ${USER} --num_nodes ${NUM_NODES} --dataset_root_dir ${DATASET_ROOT_DIR} --dataset ${DATASET} "${CMD}"
